...
def main_menu():
    ...
    add_dir("[COLOR deepskyblue] SKIN PRINCIPAL : [/COLOR] Téléchargement et application.", 'pack_weebox_full', 'call_save', artworkPath + 'skin.png')
    add_dir("[COLOR deepskyblue] TV & REPLAY : [/COLOR] Téléchargement et application.", 'pack_weebox_tv', 'call_save', artworkPath + 'tv.png')
    add_dir("[COLOR deepskyblue] FILMS : [/COLOR] Téléchargement et application.", 'pack_weebox_films', 'call_save', artworkPath + 'films.png')
    add_dir("[COLOR deepskyblue] SERIES : [/COLOR] TTéléchargement et application.", 'pack_weebox_series', 'call_save', artworkPath + 'series.png')
    add_dir("[COLOR deepskyblue] KIDS : [/COLOR] Téléchargement et application.", 'pack_weebox_series', 'call_save', artworkPath + 'kids.png')
    add_dir("[COLOR deepskyblue] DOCS & CONCERTS : [/COLOR] Téléchargement et application.", 'pack_weebox_docs', 'call_save', artworkPath + 'docs.png')
