...
def main_menu():
    add_dir("[COLOR deepskyblue] SKINS WEEBOX : SELECTIONNER UN SKIN A APPLIQUER[/COLOR]", '', 'call_save', artworkPath + 'skin.png')
    ...
    add_dir("[COLOR deepskyblue] SAUVEGARDE & RESTAURATION : SELECTIONNER UNE FONCTION[/COLOR]", '', 'call_save', artworkPath + 'save.png')
    ...
    add_dir("------------------------------------------------------------------------------------------------------------------------------", '', 'call_save', artworkPath + 'icone.png')	
    add_dir("[COLOR green] SPECIAL : [/COLOR] SELECTIONNER UNE FONCTION (EN COURS...) :", '', 'call_save', artworkPath + 'private.png')    
