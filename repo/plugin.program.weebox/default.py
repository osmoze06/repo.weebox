...
def main_menu():
    ...
    add_dir("[COLOR deepskyblue] SKIN PRINCIPAL : [/COLOR] Téléchargement du pack.", 'pack_weebox_full', 'call_save', artworkPath + 'skin.png')
    add_dir("[COLOR deepskyblue] TV & REPLAY : [/COLOR] Téléchargement du pack.", 'pack_weebox_tv', 'call_save', artworkPath + 'tv.png')
    add_dir("[COLOR deepskyblue] FILMS : [/COLOR] Téléchargement du pack.", 'pack_weebox_films', 'call_save', artworkPath + 'films.png')
    add_dir("[COLOR deepskyblue] SERIES : [/COLOR] Téléchargement du pack.", 'pack_weebox_series', 'call_save', artworkPath + 'series.png')
    add_dir("[COLOR deepskyblue] KIDS : [/COLOR] Téléchargement du pack.", 'pack_weebox_series', 'call_save', artworkPath + 'kids.png')
    add_dir("[COLOR deepskyblue] DOCS & CONCERTS : [/COLOR] Téléchargement du pack.", 'pack_weebox_docs', 'call_save', artworkPath + 'docs.png')
    ...
    add_dir("[COLOR deepskyblue] SAUVEGARDER - SLOT 01 : [/COLOR] Sauvegarde du Skin.", 'skin_save_01', 'call_save', artworkPath + 'save1.png')
    add_dir("[COLOR deepskyblue] SAUVEGARDER - SLOT 02 : [/COLOR] Sauvegarde du Skin.", 'skin_save_02', 'call_save', artworkPath + 'save2.png')
    add_dir("[COLOR deepskyblue] SAUVEGARDER - SLOT 03 : [/COLOR] Sauvegarde du Skin.", 'skin_save_03', 'call_save', artworkPath + 'save3.png')
    add_dir("------------------------------------------------------------------------------------------------------------------------------", '', 'call_save', artworkPath + '')
    add_dir("[COLOR deepskyblue] RESTAURATION : SELECTIONNER UNE FONCTION[/COLOR]", '', 'call_save', artworkPath + 'restore0.png')
    add_dir("[COLOR deepskyblue] RESTAURER - SLOT 01 : [/COLOR] Restauration du Skin.", 'skin_restor_01', 'call_save', artworkPath + 'restore1.png')
